...
class EmailHandler:
    ...
    def send_email(self, to, subject, body, thread_id=None, attachment=None):
        """Sends an email using the Gmail API, with optional attachment."""
        try:
            ...
            if attachment:
                ...
                message.attach(part)
                logger.info(f"Attaching file: {attachment.name}")
